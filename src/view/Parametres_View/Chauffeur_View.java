...
public class Chauffeur_View extends JFrame implements Parametre_View {
	...
	public Chauffeur_View() {
		...
		panel.setBounds(0, 0, 906, 561);
		frame.getContentPane().add(panel);
		panel.setLayout(null);

		btn_Ajouter = new JButton("");
		btn_Ajouter.setRolloverIcon(new ImageIcon(Chauffeur_View.class.getResource("/img/ajouter_ap.png")));
		...
		btn_Supprimer.setRolloverIcon(new ImageIcon(Chauffeur_View.class.getResource("/img/dalete_ap.png")));
		btn_Supprimer.setBounds(56, 392, 156, 44);
		panel.add(btn_Supprimer);
		btn_Supprimer.setBorder(null);
		btn_Supprimer.setIcon(new ImageIcon(Chauffeur_View.class.getResource("/img/delete.png")));

		btn_Modifier = new JButton("");
		btn_Modifier.setRolloverIcon(new ImageIcon(Chauffeur_View.class.getResource("/img/edit_ap.png")));
		btn_Modifier.setBounds(56, 447, 156, 44);
		panel.add(btn_Modifier);
		btn_Modifier.setBorder(null);
		btn_Modifier.setIcon(new ImageIcon(Chauffeur_View.class.getResource("/img/edit.png")));
		...
		panel.add(field_Nom);
		field_Nom.setForeground(new Color(0, 0, 0));
		...
		field_Prenom.setForeground(new Color(0, 0, 0));
		...
		field_Mobile.setForeground(new Color(0, 0, 0));
		...
		lblChauffeur.setFont(new Font("Times New Roman", Font.BOLD, 35));
		lblChauffeur.setForeground(new Color(0, 0, 128));
		lblChauffeur.setBounds(32, 19, 168, 45);
		panel.add(lblChauffeur);
		...
		lbTestChar.setBounds(56, 301, 204, 14);
		...
		lbTestSize.setBounds(56, 301, 168, 14);
		panel.add(lbTestSize);

		label = new JLabel("");
		label.setIcon(new ImageIcon(Chauffeur_View.class.getResource("/img/wall2.png")));
		label.setBounds(0, 0, 933, 561);
	...
	public Chauffeur getInformations() {

		return new Chauffeur(field_Nom.getText().toString(), field_Prenom.getText().toString(),
	...
	public void Test() throws OverInderSize_Exception, NoLettersOrNoDigital_Exception {
		...
		if (i != 0)
			throw new OverInderSize_Exception(" Le nom du chauffeur est trés lang ! ",
					" Le nom du chauffeur est trés court ! ", i);
		...
		if (i != 0)
			throw new OverInderSize_Exception(" Le prénom du chauffeur est trés long ! ",
					" Le prénom du chauffeur est trés court ! ", i);
	...
	public Chauffeur RowToObject() {
		...
		if (i != -1) {
			...
			return new Chauffeur(nom, prenom, tel);
		}
		return null;
	}
